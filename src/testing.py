...
csv_filename = "data_sheet_faces95.csv"
wrong_det = 0
...
def main(testing_dir_path):
    ...
    for sub in subject_list:
        ...
        for image in sub_images:
            ...
            face, rec = facedetect.detectFaces(haar_face_cascade, in_img)
            ...
            if float(ans) == float(sub[1:]):
                ...
                facedetect.draw_text(in_img, ans, x, y)
            else:
                print(img_path)
                cv2.imshow('wrong match', in_img)
